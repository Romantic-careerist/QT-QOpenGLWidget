...
float vertices[]={
    ...
    -0.5f,0.5f,0.0f,0.5f,0.5f,0.5f,0.0f,1.0f//3 top left
};
...
void AXBOpenGLWidget::initializeGL()
{
    ...
    textureLe=new QOpenGLTexture(QImage(":/resources/u=810829571,2690492918_fm=253_fmt=auto_app=138_f=JPEG.jpeg"));
